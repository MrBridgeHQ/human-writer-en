...
English AI-text humanizer **with a deterministic 0–100 detector** — a Claude Code Agent Skill.
Make English AI text read human, and **audit it with a score** before you publish.

**→ The skill lives in [`skills/human-writer-en/`](skills/human-writer-en/)** — `SKILL.md`, `references/`, and the `analyze.py` scorer.
